...
import { EDGE_ANIMATION_SPEEDS, EDGE_STYLES, EDGE_TERMINAL_TYPES, NODE_STATUSES } from './generator';
  ...
  return (
    <DefaultEdge
      ...
      animationDuration={
        ...
        getEdgeAnimationDuration(EDGE_ANIMATION_SPEEDS[data.index % EDGE_ANIMATION_SPEEDS.length])
      }
      endTerminalType={
        options.terminalTypes
          ? EDGE_TERMINAL_TYPES[data.index % EDGE_TERMINAL_TYPES.length]
